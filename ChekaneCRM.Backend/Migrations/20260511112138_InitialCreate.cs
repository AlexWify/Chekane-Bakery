    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Calories", "Carbohydrates", "Category", "Description", "Fats", "Ingredients", "IsAvailable", "Name", "Price", "Proteins" },
                values: new object[,]
                {
                    { 1, 0, 0.0, "Булочки", "Слоеный с маслом", 0.0, "", true, "Круассан", 120m, 0.0 },
                    { 2, 0, 0.0, "Хлеб", "Хрустящий французский", 0.0, "", true, "Багет", 80m, 0.0 },
                    { 3, 0, 0.0, "Торты", "Нежный медовый торт", 0.0, "", true, "Медовик", 450m, 0.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@chekane.ru", "admin", "Админ", "Dde303dde", "79991234567", 1, "Иванов" });
